...
public class HumanType : ObjectGraphType<Human>
{
    public HumanType(StarWarsData data)
    {
        ...
        Field<NonNullGraphType<StringGraphType>>("id").Description("The id of the human.").Resolve(context => context.Source.Id);
        ...
        Field<StringGraphType>("homePlanet").Description("The home planet of the human.").Resolve(context => context.Source.HomePlanet);
